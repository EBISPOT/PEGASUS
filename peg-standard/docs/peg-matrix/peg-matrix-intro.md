...
5. **Per gene evidence summary (author’s conclusion)**  
      &nbsp;&nbsp;&nbsp;&nbsp;- Provide a cumulative weight-of-evidence score or a qualitative conclusion. This column is mandatory and must be labelled as `author_conclusion=True` in the metadata. It acts as the primary key linking the PEG matrix and the PEG list. Here, we suggest to consider selecting highest-ranked gene from each locus. 
...
2. [PEG Metadata Standard](../peg-metadata/peg-metadata.md?peg-metadata-tab=genomic-identifier#standard-content)
...
---
* 🎠 [View PEG Matrix Toy Example](../peg-toy-example.md#peg-evidence-matrix)
